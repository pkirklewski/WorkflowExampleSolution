namespace WorkflowExample {
    ...
    #line 15 "C:\Users\LT5244\source\repos\WorkflowExampleSolution\WorkflowExample\Workflow1.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "C:\Users\LT5244\source\repos\WorkflowExampleSolution\WorkflowExample\Workflow1.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 16 "C:\Users\LT5244\source\repos\WorkflowExampleSolution\WorkflowExample\Workflow1.xaml"
    ...
    #line 17 "C:\Users\LT5244\source\repos\WorkflowExampleSolution\WorkflowExample\Workflow1.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 18 "C:\Users\LT5244\source\repos\WorkflowExampleSolution\WorkflowExample\Workflow1.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 19 "C:\Users\LT5244\source\repos\WorkflowExampleSolution\WorkflowExample\Workflow1.xaml"
    using System.Text;
    ...
    public partial class Workflow1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        public object InvokeExpression(int expressionId, System.Collections.Generic.IList<System.Activities.LocationReference> locations, System.Activities.ActivityContext activityContext) {
            ...
            if ((expressionId == 0)) {
                System.Activities.XamlIntegration.CompiledDataContext[] cachedCompiledDataContext = Workflow1_TypedDataContext2_ForReadOnly.GetCompiledDataContextCacheHelper(this.dataContextActivities, activityContext, this.rootActivity, this.forImplementation, 1);
        ...
        private class Workflow1_TypedDataContext2 : Workflow1_TypedDataContext1 {
            ...
            protected override void GetValueTypeValues() {
                this.a = ((int)(this.GetVariableValue((1 + locationsOffset))));
                base.GetValueTypeValues();
            }
            
            protected override void SetValueTypeValues() {
                this.SetVariableValue((1 + locationsOffset), this.a);
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 0)].Name != "variable1") 
                            || (locationReferences[(offset + 0)].Type != typeof(string)))) {
                    return false;
                }
                if (((locationReferences[(offset + 2)].Name != "s") 
                            || (locationReferences[(offset + 2)].Type != typeof(string)))) {
                    return false;
                }
                if (((locationReferences[(offset + 3)].Name != "y") 
                            || (locationReferences[(offset + 3)].Type != typeof(string)))) {
                    return false;
                }
                if (((locationReferences[(offset + 4)].Name != "n") 
                            || (locationReferences[(offset + 4)].Type != typeof(string)))) {
                    return false;
                }
                if (((locationReferences[(offset + 5)].Name != "e") 
                            || (locationReferences[(offset + 5)].Type != typeof(string)))) {
                    return false;
                }
                if (((locationReferences[(offset + 1)].Name != "a") 
        ...
        private class Workflow1_TypedDataContext2_ForReadOnly : Workflow1_TypedDataContext1_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 51 "C:\USERS\LT5244\SOURCE\REPOS\WORKFLOWEXAMPLESOLUTION\WORKFLOWEXAMPLE\WORKFLOW1.XAML"
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 60 "C:\USERS\LT5244\SOURCE\REPOS\WORKFLOWEXAMPLESOLUTION\WORKFLOWEXAMPLE\WORKFLOW1.XAML"
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 89 "C:\USERS\LT5244\SOURCE\REPOS\WORKFLOWEXAMPLESOLUTION\WORKFLOWEXAMPLE\WORKFLOW1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
                        n;
            ...
            internal System.Linq.Expressions.Expression @__Expr3GetTree() {
                ...
                #line 73 "C:\USERS\LT5244\SOURCE\REPOS\WORKFLOWEXAMPLESOLUTION\WORKFLOWEXAMPLE\WORKFLOW1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
                            e;
            ...
            internal System.Linq.Expressions.Expression @__Expr4GetTree() {
                ...
                #line 66 "C:\USERS\LT5244\SOURCE\REPOS\WORKFLOWEXAMPLESOLUTION\WORKFLOWEXAMPLE\WORKFLOW1.XAML"
                System.Linq.Expressions.Expression<System.Func<string>> expression = () => 
                        y;
